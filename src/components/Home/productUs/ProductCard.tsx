...
export default function ProductCard() {
  const gradient = "linear-gradient(180deg, rgba(255, 255, 255, 0.00) 0%, #FFF 100%)";
  ...
  return (
    <div className="w-40 h-40 relative inline-block justify-center rounded-3xl overflow-hidden ml-2 first:ml-0">
      ...
      <div className="w-full h-16 absolute bottom-0 pb-1 px-5 flex items-end" style={{ background: gradient }}>
